...
![](est_acf.png){width=500px height=500px}

<br>

![](est_pacf.png){width=500px height=500px}

These ACF and PACF plots are based on the prediction set of data for the periods after Jan 1, 2020.

<br>

![](pred_acf.png){width=500px height=500px}


<br>

![](pred_pacf.png){width=500px height=500px}
...
![](ld_est_acf.png){width=500px height=500px}

<br>

![](ld_est_pacf.png){width=500px height=500px}


<br>

![](ld_pred_acf.png){width=500px height=500px}


<br>

![](ld_pred_pacf.png){width=500px height=500px}
