...
<div style="float: left; width: 50%;">
- Stationarity
- The Augmented Dickey-Fuller Test shows we can not reject that the log/diff is not stationary
- The KPSS Test; however, shows that we can not reject that the log/diff stationary around a deterministic trend
